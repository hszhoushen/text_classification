...
labels = to_categorical(np.asarray(labels))     # 40000 word vectors
print('Shape of data tensor:', len(texts))      # 25000
print('Shape of label tensor:', len(labels))    # 25000

tokenizer = Tokenizer(num_words=MAX_NB_WORDS)
tokenizer.fit_on_texts(texts)
sequences = tokenizer.texts_to_sequences(texts)
word_index = tokenizer.word_index
# longest length of a review is 1000
